...
(
  ...
  email_bind         BOOLEAN DEFAULT FALSE                                            NOT NULL
  COMMENT 'bind with email',
  mobile             VARCHAR(11) DEFAULT ''                                           NOT NULL
  COMMENT 'mobile number',
  mobile_bind        BOOLEAN DEFAULT FALSE                                            NOT NULL
...
VALUES
  ('happyliping', 'shihao', 'shihao', 'afafadfa', 'shihaosun.usc@gmail.com', TRUE , '2133998198', FALSE , now(), now(), now(), 1,
   FALSE );

INSERT INTO `user` (username, first_name, last_name, password, email, email_bind, mobile, mobile_bind, create_time, update_time, last_login_time, status, is_delete)
VALUES
  ('happycora', 'shihao', 'shihao', 'afafadfa', 'shihaosun.usc@gmail.com', TRUE , '2133998198', FALSE , now(), now(), now(), 1,
   FALSE);

INSERT INTO user (username, first_name, last_name, password, email, email_bind, mobile, mobile_bind, create_time, update_time, last_login_time, status, is_delete)
VALUES ('shihao', 'shihao', 'sun', 'password', '@gmail.com', FALSE, '8123612205', TRUE , '2018-04-08 16:45:03',
                  '2018-04-08 16:45:03', '2018-04-08 16:45:03', 1, TRUE );

INSERT INTO user (username, first_name, last_name, password, email, email_bind, mobile, mobile_bind, status, is_delete)
VALUES ('shihao1', 'shihao', 'sun', 'password', '@gmail.com', TRUE , '8123612205', FALSE , 1, TRUE );